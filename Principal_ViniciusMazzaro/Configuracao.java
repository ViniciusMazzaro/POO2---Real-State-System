...
public class Configuracao {
    ...
    public String toString() {
        return "Configuracao {" +
                "arquivoAlugueis='" + arquivoAlugueis + '\'' +
                ", arquivoVendas='" + arquivoVendas + '\'' +
                ", arquivoImoveis='" + arquivoImoveis + '\'' +
                ", arquivoClientes='" + arquivoClientes + '\'' +
                ", arquivoCorretores='" + arquivoCorretores + '\'' +
                ", arquivoSeguros='" + arquivoSeguros + '\'' +
                '}';
    }
}